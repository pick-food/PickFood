...
export const HERO_BANNER: HeroBanner = {
  ...
  ctaText: "지금 쇼핑하기",
  imageSrc: "/images/banners/hero-banner.png",
...
export const SIDE_BANNERS: SideBanner[] = [
  {
    ...
    tagBg: "bg-primary",
    title: "저GL 식품만\n모아봤어요",
    imageSrc: "/images/banners/side-banner-1.png",
  ...
  },
  {
    ...
    tagBg: "bg-safe",
    title: "식물성 100%\n비건 식품관",
    imageSrc: "/images/banners/side-banner-2.png",
...
export const AD_BANNERS: AdBanner[] = [
  {
    ...
    imageSrc: "/images/banners/ad-banner-1.png",
  ...
  },
  {
    ...
    highlight: "당류 70% 감소",
    highlightColor: "text-accent-peach",
    imageSrc: "/images/banners/ad-banner-2.png",
  ...
  },
  {
    ...
    imageSrc: "/images/banners/ad-banner-3.png",
    gradientFrom: "from-green-800",
